...
#include "crocoddyl/core/activations/activation-base.hpp"
...
struct CostDataAbstractTpl
{
    ...
    DEPRECATED(
        "Use residual.Rx", const MatrixXs& get_Rx() const { return residual->Rx; };)
    DEPRECATED(
        "Use residual.Ru", const MatrixXs& get_Ru() const { return residual->Ru; };)
    DEPRECATED(
        "Use residual.r", void set_r(const VectorXs& r) { residual->r = r; };)
    DEPRECATED(
        "Use residual.Rx", void set_Rx(const MatrixXs& Rx) { residual->Rx = Rx; };)
    DEPRECATED(
        "Use residual.Ru", void set_Ru(const MatrixXs& Ru) { residual->Ru = Ru; };)
